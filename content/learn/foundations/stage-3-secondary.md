...
> **Info:** Typically grades 9-12 (ages 14-18), essential preparation for university STEM programs.
...
Ready for college-level work? Continue to [Stage 4: College Core](/learn/foundations/stage-4-college-core/) where you'll dive into calculus, advanced programming, and specialized sciences.

Considering research now? You have enough foundation to begin the [Research Engineering Path](/learn/research-engineering/getting-started/) while continuing to build advanced skills.
