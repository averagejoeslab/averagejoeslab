---
sidebar_position: 1
title: Research Engineering - Getting Started
description: Introduction to the research engineering learning path
---

# Getting Started with Research Engineering

> **Info:** This Research Engineering Learning Path is currently in **beta**. We're actively improving and refining the content based on community feedback and real-world usage.
>
> **Help us improve:**
...
### **[Part 1: The Universal Research Process](/learn/research-engineering/research-process/)**
...
### **[Part 2: The Perceptron Research Journey](/learn/research-engineering/perceptron-research-example/)**
...
> **Info:** **Prerequisites are NOT required to begin!** Our **[STEM Foundations Learning Path](/learn/foundations/getting-started/)** provides comprehensive support from Pre-K to graduate level for just-in-time learning.

**Available Foundation Topics:**

- **[Stage 0: Early Foundations (Pre-K to Grade 2)](/learn/foundations/stage-0-early/)**: Number sense & counting, basic operations, shapes & patterns, observation skills, living things, simple experiments

- **[Stage 1: Primary Foundations (Grades 3-5)](/learn/foundations/stage-1-primary/)**: Multiplication & division, fractions/decimals/percentages, measurement & data, introduction to physics, basic chemistry, earth & space science

- **[Stage 2: Middle School Foundations (Grades 6-8)](/learn/foundations/stage-2-middle/)**: Pre-algebra & algebra I, geometry, life science/biology, physical science, chemistry basics, Python programming, data structures basics

- **[Stage 3: Secondary Foundations (Grades 9-12)](/learn/foundations/stage-3-secondary/)**: Algebra II, trigonometry, pre-calculus, physics (algebra-based), chemistry, biology, object-oriented programming, algorithms & complexity

- **[Stage 4: College Core (Years 1-2)](/learn/foundations/stage-4-college-core/)**: Calculus I & II, linear algebra, probability & statistics, discrete mathematics, data structures & algorithms, computer systems, scientific computing

- **[Stage 5: Expansion (Years 2-3)](/learn/foundations/stage-5-expansion/)**: Multivariable calculus, advanced linear algebra, differential equations, probability theory, statistical inference, machine learning foundations, database systems

- **[Stage 6: Advanced Topics (Years 3-4)](/learn/foundations/stage-6-advanced/)**: Graduate-level mathematics, numerical analysis, high-performance computing, scientific computing frameworks, research methods, specialized domains (ML, computational biology, quantum computing)

### **Field-Specific Learning Paths**

**For AI/Machine Learning Research:**
- Start with [Python Programming (Stage 2)](/learn/foundations/stage-2-middle/#python-programming)
- Add [Linear Algebra (Stage 4)](/learn/foundations/stage-4-college-core/#linear-algebra)
- Learn [Calculus I & II (Stage 4)](/learn/foundations/stage-4-college-core/#calculus-i) for optimization
- Study [Probability & Statistics (Stage 4)](/learn/foundations/stage-4-college-core/#probability--statistics)
- Advance to [Machine Learning Foundations (Stage 5)](/learn/foundations/stage-5-expansion/#machine-learning-foundations)

**For Biology/Life Sciences Research:**
- Begin with [Observation Skills (Stage 0)](/learn/foundations/stage-0-early/#observation-skills)
- Learn [Life Science/Biology (Stage 2)](/learn/foundations/stage-2-middle/#life-science--biology)
- Add [Biology (Stage 3)](/learn/foundations/stage-3-secondary/#biology) for deeper understanding
- Study [Probability & Statistics (Stage 4)](/learn/foundations/stage-4-college-core/#probability--statistics)
- Explore [Computational Biology (Stage 6)](/learn/foundations/stage-6-advanced/#computational-biology) if interested

**For Psychology/Social Sciences Research:**
- Start with [Scientific Method (Stage 1)](/learn/foundations/stage-1-primary/#introduction-to-physics)
- Focus on [Probability & Statistics (Stage 4)](/learn/foundations/stage-4-college-core/#probability--statistics)
- Learn [Statistical Inference (Stage 5)](/learn/foundations/stage-5-expansion/#statistical-inference)
- Add [Research Design (Stage 6)](/learn/foundations/stage-6-advanced/#research-design)
- Study [Time Series Analysis (Stage 5)](/learn/foundations/stage-5-expansion/#time-series-analysis) for longitudinal studies

**For Physics & Engineering Research:**
- Master [Calculus I-III (Stages 4-5)](/learn/foundations/stage-4-college-core/#calculus-i)
- Study [Physics with Calculus (Stage 4)](/learn/foundations/stage-4-college-core/#physics-with-calculus)
- Learn [Differential Equations (Stage 5)](/learn/foundations/stage-5-expansion/#differential-equations)
- Add [Numerical Methods (Stage 5)](/learn/foundations/stage-5-expansion/#numerical-methods)
- Explore [High-Performance Computing (Stage 6)](/learn/foundations/stage-6-advanced/#high-performance-computing)

**For Economics & Data Science Research:**
- Start with [Algebra II (Stage 3)](/learn/foundations/stage-3-secondary/#algebra-ii)
- Learn [Probability & Statistics (Stage 4)](/learn/foundations/stage-4-college-core/#probability--statistics)
- Add [Time Series Analysis (Stage 5)](/learn/foundations/stage-5-expansion/#time-series-analysis)
- Study [Database Systems (Stage 5)](/learn/foundations/stage-5-expansion/#database-systems)
- Master [Statistical Inference (Stage 5)](/learn/foundations/stage-5-expansion/#statistical-inference)
...
- **[STEM Foundations](/learn/foundations/getting-started/)** - Just-in-time learning support when you need it
