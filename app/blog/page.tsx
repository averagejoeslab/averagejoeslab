...
export const metadata: Metadata = {
  title: 'Blog',
  description: 'Insights on research methodology, citizen science, and open research from the Average Joes Lab community.',
  openGraph: {
    title: 'Blog',
    description: 'Insights on research methodology, citizen science, and open research from the Average Joes Lab community.',
  },
        ...
        <div className="relative container-max section-padding">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
              Insights, strategies, and thought leadership on research methodology, citizen science, and open research.
            </p>
          </div>
        </div>
      </section>
